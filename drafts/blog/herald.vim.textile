...
Furthermore, Vim allows you to create color schemes, and that's surprisingly easy to do. Everything you need to do is in the "docs":http://vimdoc.sourceforge.net/htmldoc/syntax.html, but that may put you off, so you can just start by editing an existing one -- that's what I did.

h3. InfiniteRed Black
...
!=/images/h3rald.vim/ir_black_vim_example.png! 
...
!=/images/h3rald.vim/moria_vim_example.png! 
...
Meet <strong> "herald.vim":/files/herald.vim </strong> (this is a direct link to the raw file, but you may also want to check my "stash":http://github.com/h3rald/stash/tree/master on GitHub):

!=/images/h3rald.vim/herald_vim_example.png! 
